		...
		<Form {...form}>
			...
			>
				<FormField
					...
					name="thread"
					render={({ field }) => (
						<FormItem className="flex items-center flex-1 w-full gap-3">
							<FormLabel>
								<Image src={currentUserImg} alt="Profile Photo" width={48} height={48} className="rounded-full object-cover aspect-square" />
							</FormLabel>
